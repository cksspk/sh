...
export FRPS_INIT="https://code.aliyun.com/MvsCode/frps-onekey/raw/master/frps.init"
...
str_install_shell="https://code.aliyun.com/MvsCode/frps-onekey/raw/master/install-frps.sh"
shell_update(){
    fun_clangcn "clear"
